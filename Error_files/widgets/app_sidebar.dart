        ...
        children: [
          ...
          _buildSidebarItem(
            ...
            onTap: () {
              ...
              widget.onPageChanged?.call(0); // Navigate to Home
            },
          ...
          _buildSidebarItem(
            ...
            onTap: () {
              ...
              widget.onPageChanged?.call(1); // Navigate to Search
            },
            primaryColor: primaryColor,
            textColor: textColor,
          ),
          ...
          _buildSidebarItem(
            ...
            onTap: () {
              ...
              widget.onPageChanged?.call(2); // Navigate to Library
            },
            primaryColor: primaryColor,
            textColor: textColor,
          ),
      ...
      child: SizedBox(
        ...
        child: Row(
          ...
          children: [
            // Rotated text
            RotatedBox(
              quarterTurns: -1, // Rotates 90 degrees counter-clockwise
              child: Text(
                label,
                style: TextStyle(
