                        ...
                        return Row(
                          ...
                          children: [
                            _buildThemeButton(
                              ...
                              isActive: !themeProvider.isDarkMode && !themeProvider.useSystemTheme,
                              onTap: () {
  ...
  Widget _buildThemeButton(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isActive ? primaryColor.withAlpha((0.2 * 255).round()) : Colors.transparent,
          borderRadius: BorderRadius.circular(10),
        ),
        child: Icon(
          icon,
          color: isActive ? primaryColor : (isDark ? Colors.grey.shade500 : Colors.grey.shade600),
          size: 18,
        ),
      ),
    );
