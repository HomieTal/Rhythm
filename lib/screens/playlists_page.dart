...
import 'dart:convert';
import 'package:rhythm/screens/fav_page.dart';
import 'package:rhythm/screens/history_page.dart';
import 'package:rhythm/screens/offline_playlist_page.dart';
...
import 'package:rhythm/services/playlist_service.dart';
...
import 'package:rhythm/screens/playlist_detail_page.dart';
...
class _PlaylistsPageState extends State<PlaylistsPage> with AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    super.initState();
    // Delay initialization to avoid concurrent operations
  ...
  Future<void> _initializeData() async {
    try {
      await PlaylistService.instance.loadFromStorage();
      await importedPlaylistService.loadImportedPlaylists();
      await _loadCustomPlaylists();
      await _loadOfflineSongsCount();
      _hasLoadedOnce = true;
    } catch (e) {
      debugPrint('Error initializing playlists page: $e');
      _hasLoadedOnce = true;
    }
  }
  ...
  Future<void> _loadOfflineSongsCount() async {
    try {
      ...
      debugPrint('Error loading offline songs count: $e');
      if (mounted) {
        setState(() {
          _offlineSongsCount = 0;
        });
      }
    }
  }
                            ...
                            SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, idx) {
                                  ...
                                  final colors = [
                                    const Color(0xFF5C3A7C),
                                    const Color(0xFF3A5C7C),
                                    const Color(0xFF7C3A5C),
                                    const Color(0xFF7C5C3A),
                                    const Color(0xFF3A7C5C),
                                    const Color(0xFF5C7C3A),
                                    const Color(0xFF7C3A3A),
                                    const Color(0xFF3A7C7C),
                                    const Color(0xFF7C7C3A),
                                    const Color(0xFF3A3A7C),
                                  ];
